...
extension DateFormatter {
    ...
    static let HourMinuteFormatter: DateFormatter = {
        ...
        //format - only need hours : minuts AM/PM as thats all that is returned from the API
        formatter.dateFormat = "hh:mma"
        
        //time zone for the formatter - use zero seconds as the time already comes "pre-timezoned"
//        formatter.timeZone = TimeZone(secondsFromGMT: 0)
        
        //default date used to constuct a date from string if there are missing pieces
