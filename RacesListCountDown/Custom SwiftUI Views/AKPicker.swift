...
public class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
        ...
        didSet {
            self.collectionView.layer.mask = self.maskDisabled == true ? nil : {
                ...
                maskLayer.colors = [
                    ...
                    UIColor.black.cgColor,
                    UIColor.clear.cgColor]
                maskLayer.locations = [0.05, 0.33, 0.66, 0.95]
    ...
    */
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        //this block is for keeping the mask centered in the collection view
        ...
        //This next block is responsible for selecting a cell when in the middle
